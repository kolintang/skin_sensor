...
// uSkin fingertip 1.3 (2SDA only) (Has chip order 00 01 10 11)
// 11/16/2017 - add one more library that send to all SDA
...
unsigned int MLX90393Buffer_0[8]; //only for a single sda
int write_buffer[4];
            ...
            case  (EIGHT_BITS):
            {
                ...
                case CONFIG_SINGLE :
                {
                   ...
                   // Read the measurement
                    ...
                    //SendViaI2C_MLX_onSdaX(CH0, MLX90393_ADD[i],0, RM, 1, MLX90393Buffer_1, 7); //for SDA1 only
                   
                    // fill the CAN with measurement data
                    for(j = 0; j < 2; j++){ // j < 1 --> only SDA 1
...
void MLX90393_init(unsigned char i2c_address){
    ...
    //SendCommandI2C_MLX_sdax(CH0, i2c_address, 0 , write_buffer, MLX90393Buffer_1, 1);
    //FillCanMessages8bit_hall(CH0, 0);
    //SendCommandI2C_MLX_sdax(CH0, i2c_address, 1 , write_buffer, MLX90393Buffer_2, 1);//for SDA1 only
    //FillCanMessages8bit_hall(CH0, 1);
    }
    ...
    write_buffer[3] = i << 2;
    SendCommandI2C_MLX(CH0, i2c_address, write_buffer, MLX90393Buffer_1, MLX90393Buffer_2, MLX90393Buffer_3, MLX90393Buffer_4, 1);
    //SendCommandI2C_MLX_sdax(CH0, i2c_address, 0 , write_buffer, MLX90393Buffer_1, 1); //sda 1
   // FillCanMessages8bit_hall(CH0, 0);
    }
    ...
    //SendViaI2C_MLX_onSdaX(CH0, i2c_address, 0, SB, 1, MLX90393Buffer_1, 1); //SDA1 Only
    FillCanMessages8bit_hall(CH0, 0);
...
void MLX90393_calibration(unsigned char i2c_address) {
    ...
    //SendViaI2C_MLX(CH0, 0x0C, RM, 1, MLX90393Buffer_1, MLX90393Buffer_2, MLX90393Buffer_3, MLX90393Buffer_4, 7);
    SendViaI2C_MLX_finger(CH0, 0x0C, RM, 1, MLX90393Buffer_1, MLX90393Buffer_2, 7);
    //SendViaI2C_MLX_onSdaX(CH0, 0x0C,0, RM, 1, MLX90393Buffer_1, 7); //SDA1 chip 0 test
    FillCanMessages8bit_hall(CH0, 0);
    ...
    SendCommandI2C_MLX(CH0, i2c_address, write_buffer, MLX90393Buffer_1, MLX90393Buffer_2, MLX90393Buffer_3, MLX90393Buffer_4, 1);
    //SendCommandI2C_MLX(CH0, i2c_address, write_buffer, MLX90393Buffer_1, MLX90393Buffer_2, 1);
    //SendCommandI2C_MLX_sdax(CH0, i2c_address, 0 , write_buffer, MLX90393Buffer_1, 1); //send to SDA1 only
    //FillCanMessages8bit_hall(CH0, 0);
    ...
    //SendViaI2C_MLX(CH0, i2c_address, SB, 1, MLX90393Buffer_1, MLX90393Buffer_2, MLX90393Buffer_3, MLX90393Buffer_4, 1);
    SendViaI2C_MLX_finger(CH0, i2c_address, SB, 1, MLX90393Buffer_1, MLX90393Buffer_2, 1);
    //SendViaI2C_MLX_onSdaX(CH0, i2c_address, 0, SB, 1, MLX90393Buffer_1, 1); //for SDA1 only
    //FillCanMessages8bit_hall(CH0, 1 );
}
